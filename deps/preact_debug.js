...
import { Fragment as U, options as i, Component as T } from "preact";
...
var M = !1;
function x(n) {
  return typeof n.type == "function" && n.type != U;
}
function c(n) {
  for (var f = [n], l = n; l.__o != null; ) f.push(l.__o), (l = l.__o);
  return f.reduce(function (u, d) {
    u += "  in " + _(d);
    var p = d.__source;
    return (
      p
        ? (u += " (at " + p.fileName + ":" + p.lineNumber + ")")
        : M ||
          ((M = !0),
          console.warn(
...
function W(n) {
  return n ? (typeof n.type == "function" ? W(n.__) : n) : {};
}
var R = T.prototype.setState;
T.prototype.setState = function (n, f) {
  return (
    this.__v == null &&
      this.state == null &&
      console.warn(
...
function h(n) {
  var f = n.props,
    ...
    u = "";
  for (var d in f)
    if (f.hasOwnProperty(d) && d !== "children") {
      var p = f[d];
      typeof p == "function" &&
        (p = "function " + (p.displayName || p.name) + "() {}"),
        (p =
          Object(p) !== p || p.toString
            ? p + ""
            : Object.prototype.toString.call(p)),
        (u += " " + d + "=" + JSON.stringify(p));
    }
  var g = f.children;
  return "<" + l + u + (g && g.length ? ">..</" + l + ">" : " />");
}
  ...
  (function () {
    (function () {
      ...
      (i.diffed = function (r) {
        ...
        (i.vnode = function (r) {
          (r.__o = w.length > 0 ? w[w.length - 1] : null), a && a(r);
        }),
        (i.__r = function (r) {
          x(r) && w.push(r), s && s(r);
        });
...
` +
        ...
        if (typeof t.type == "function" && t.type.propTypes) {
          if (
            t.type.displayName === "Lazy" &&
            O &&
            !O.lazyPropTypes.has(t.type)
          ) {
            var s =
            ...
            try {
              ...
              O.lazyPropTypes.set(t.type, !0),
                console.warn(s + "Component wrapped in lazy() is " + _(r));
            } catch {
              console.warn(
                s +
